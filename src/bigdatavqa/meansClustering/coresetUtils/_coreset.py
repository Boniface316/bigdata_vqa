'''
Code taken from coreset.py in the repository found at:
https://github.com/teaguetomesh/coresets/tree/master/kMeans
Implemented for the paper https://arxiv.org/abs/2004.14970
to be used for k-means clustering coreset construction.
'''
